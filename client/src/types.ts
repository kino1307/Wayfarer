...
// Ordered best to worst within each provider (strongest/most-capable first). Tier descriptors
// (frontier / recommended / budget) are the same three words for both providers — Sol and Opus
// are each their provider's top-capability tier, Sonnet and Terra are each the actual default
// (see DEFAULT_MODEL in App.tsx), Haiku and Luna are each the cheap tier.
export const MODEL_OPTIONS: { id: ModelId; label: string; maxTokens: number; approxNodes: number }[] = [
  { id: 'claude-opus-4-8',           label: 'Opus · frontier', maxTokens: 16000, approxNodes: 50 },
  ...
  { id: 'openai:gpt-5.6-terra',      label: 'GPT-5.6 Terra · recommended', maxTokens: 16000, approxNodes: 50 },
